...
# Recon Phase: 07-js-analysis

## Workspace
Write all output to the absolute path passed in the prompt
(`~/.dsh/hunts/<domain>/recon/07-js-analysis/`). Use absolute paths in your
...
## Phase procedure
Collect and analyze JavaScript files. Extract endpoints, API paths, tokens, secrets, internal hostnames. Prefer linkfinder/jsluice; fall back to grep against downloaded JS files.
