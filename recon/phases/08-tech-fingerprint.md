...
# Recon Phase: 08-tech-fingerprint

## Workspace
Write all output to the absolute path passed in the prompt
(`~/.dsh/hunts/<domain>/recon/08-tech-fingerprint/`). Use absolute paths in your
...
## Phase procedure
Fingerprint server, framework, CMS, libraries. Prefer wappalyzer/webanalyze; fall back to parsing Server / X-Powered-By headers and HTML meta tags. Flag known-vulnerable versions.
