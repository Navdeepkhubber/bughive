...
# Recon Phase: 09-historical-data

## Workspace
Write all output to the absolute path passed in the prompt
(`~/.dsh/hunts/<domain>/recon/09-historical-data/`). Use absolute paths in your
...
## Phase procedure
Historical URLs and parameters. Prefer gau/waybackurls; fall back to curl against web.archive.org CDX API. Filter for tokens, secrets, API keys, internal paths, admin endpoints.
