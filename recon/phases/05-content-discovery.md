...
## Phase procedure
Content discovery on in-scope hosts. Prefer ffuf; fall back to feroxbuster; if neither, skip and note. Wordlist: recon/wordlists/files.txt. Only 200, 301, 302, 401, 403 responses.
