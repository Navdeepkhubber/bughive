...
cmd_status() {
  ...
  local hd; hd="$(hunt_dir "$domain")"
  echo "root: $hd"
  for stage in scope recon-01 recon-02 recon-03 recon-04 recon-05 recon-06 recon-07 recon-08 recon-09 recon-10 hypothesis skills prefilter falsifier proof chain report quality deliver; do
